...
public class LaptopMapper {
    public static Laptop fromLaptopEntityToLaptop(LaptopEntity laptopEntities) {
        ...
        laptop.setSerialNumber(laptopEntities.getSerialNumber());
        ...
        laptop.setDescription(laptopEntities.getDescription());
        laptop.setPrecio(laptopEntities.getPrecio());
        laptop.setDescuento(laptopEntities.getDescuento());
    ...
    public static LaptopEntity fromLaptopToLaptopEntity(Laptop laptop) {
        ...
        laptopEntity.setDescription(laptop.getDescription());
